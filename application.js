...
$(document).ready(function(){
    ...
    $('#basecamp').mouseenter(function(){
		...
		$('#header-container h1').css("font-size", "44px");
    ...
    $('#basecamp').mouseleave(function(){
		...
		$('#header-container h1').css("font-size", "54px");
	...
	$('#highrise').mouseenter(function(){
        $('#header-container h1').text("Highrise remembers the important things about people youd normally forget.");
		$('#header-container h1').css("font-size", "44px");
